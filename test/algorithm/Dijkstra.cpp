...
TYPED_TEST(DijkstraTest, Dijkstra)
{
  ...
  path = d.reversePath(V[1]);
  EXPECT_EQ(2, path.size());
  EXPECT_EQ(V[1], path[0]);
  EXPECT_EQ(V[0], path[1]);
  ...
  path = d.reversePath(V[2]);
  EXPECT_EQ(3, path.size());
  EXPECT_EQ(V[2], path[0]);
  EXPECT_EQ(V[1], path[1]);
  EXPECT_EQ(V[0], path[2]);
  ...
  path = d.reversePath(V[3]);
  EXPECT_EQ(4, path.size());
  EXPECT_EQ(V[3], path[0]);
  EXPECT_EQ(V[2], path[1]);
  EXPECT_EQ(V[1], path[2]);
  EXPECT_EQ(V[0], path[3]);
  ...
  path = d.reversePath(V[4]);
  EXPECT_EQ(3, path.size());
  EXPECT_EQ(V[4], path[0]);
  EXPECT_EQ(V[5], path[1]);
  EXPECT_EQ(V[0], path[2]);
  ...
  path = d.reversePath(V[5]);
  EXPECT_EQ(2, path.size());
  EXPECT_EQ(V[5], path[0]);
  EXPECT_EQ(V[0], path[1]);
  ...
  path = d.reversePath(V[6]);
  EXPECT_EQ(3, path.size());
  EXPECT_EQ(V[6], path[0]);
  EXPECT_EQ(V[5], path[1]);
  EXPECT_EQ(V[0], path[2]);
  ...
  path = d.reversePath(V[7]);
  EXPECT_EQ(4, path.size());
  EXPECT_EQ(V[7], path[0]);
  EXPECT_EQ(V[6], path[1]);
  EXPECT_EQ(V[5], path[2]);
  EXPECT_EQ(V[0], path[3]);
  ...
  path = d.reversePath(V[8]);
  EXPECT_EQ(4, path.size());
  EXPECT_EQ(V[8], path[0]);
  EXPECT_EQ(V[4], path[1]);
  EXPECT_EQ(V[5], path[2]);
  EXPECT_EQ(V[0], path[3]);
}
